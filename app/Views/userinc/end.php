<script>
    function editreport(id, names, region, province, city, barangay, cans, varia, date, act, area, typhoonname, typhoon, heavy_rains, total_damages, cans_damages, HA, disease, list, standing_crop, planted, transplate_date, expected_date, production, Harvested, expected_volumn, Local, per_kg, php_per_kg, Cold, perkg, phpper_kg, OTHERS) {
