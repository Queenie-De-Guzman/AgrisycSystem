...
<div class="container-scroller">
  ...
  <div class="content-wrapper">
   ...
   <script>
                  document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/PalawanDamage') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
...
<div class="row mb-4 ">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/PalawanStanding') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
            ...
            <div class="col-md-6 mb-4  stretch-card transparent">
                ...
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/PalawanCrop') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
  ...
  <div class="row mb-4 ">
   ...
   <script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch('/PalawanSeedling') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
...
<br>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            // Fetch data from the PHP endpoint
            fetch('/PalawanLocation') // Adjust the path to your PHP file
                .then(response => response.json())
                .then(data => {
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/PalawanTransplate') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
                const months = data.map(item => item.dt);
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/PalawanTotal') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
