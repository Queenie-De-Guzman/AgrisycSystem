...
<div class="container-scroller">
  ...
  <div class="content-wrapper">
   ...
   <script>
                  document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/MarinduqueDamage') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
...
<div class="row mb-4 ">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/MarinduqueStanding') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
            ...
            <div class="col-md-6 mb-4  stretch-card transparent">
                ...
                document.addEventListener("DOMContentLoaded", () => {
                    // Fetch data from your CodeIgniter route
                    fetch('/MarinduqueCrop') // Replace '/calculatedamage' with the actual route that points to your calculatedamage function
                      .then(response => response.json())
                      .then(data => {
                        // Display the total damage
  ...
  <div class="row mb-4 ">
   ...
   <script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch('/MarinduqueSeedling') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
...
<br>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            // Fetch data from the PHP endpoint
            fetch('/MarinduqueLocation') // Adjust the path to your PHP file
                .then(response => response.json())
                .then(data => {
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/MarinduqueTransplate') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
                const months = data.map(item => item.dt);
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        // Fetch data from the PHP endpoint
        fetch('/MarinduqueTotal') // Adjust the path to your PHP file
            .then(response => response.json())
            .then(data => {
