...
class OccidentalDashboardController extends BaseController
{
...
public function OcciTransplate()
{
    // Setting header to json
    header('Content-Type: application/json');
