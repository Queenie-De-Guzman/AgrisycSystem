...
class PalawanDashboardController extends BaseController
{
...
public function PalawanFarmers()
{
    // Setting header to JSON
    header('Content-Type: application/json');
...
public function PalawanStanding()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function PalawanTransplate()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function PalawanLocation()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function PalawanSeedling()
{
    // Setting header to json
    header('Content-Type: application/json');
