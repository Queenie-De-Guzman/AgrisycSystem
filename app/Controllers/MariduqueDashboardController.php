...
class  MarinduqueDashboardController extends BaseController
{
    ...
    public function  MarinduqueDamage()
{
    ...
    // SQL query
    $query = "SELECT SUM(total_damages) as total FROM info WHERE user_id = $userId";
...
public function  MarinduqueFarmers()
{
    // Setting header to JSON
    header('Content-Type: application/json');
   ...
   $query = "SELECT COUNT(*) AS numFarmers FROM info WHERE user_id = $userId";
...
public function  MarinduqueStanding()
{
    // Setting header to json
    header('Content-Type: application/json');
    ...
    $query = "SELECT SUM(standing_crop) as totalcrop FROM info WHERE user_id = $userId  ";
...
public function  MarinduqueCrop()
{
    // Setting header to json
    header('Content-Type: application/json');
    ...
    $userId = 37;
    // Query to calculate total damages for a specific user
    $query = "SELECT SUM(cans_damages) as damages FROM info  WHERE user_id = $userId";
...
public function  MarinduqueTotal()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function  MarinduqueTransplate()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function  MarinduqueLocation()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function  MarinduqueSeedling()
{
    // Setting header to json
    header('Content-Type: application/json');
