...
class RomblonDashboardController extends BaseController
{
...
public function RomblonFarmers()
{
    // Setting header to JSON
    header('Content-Type: application/json');
...
public function RomblonStanding()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function RomblonTransplate()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function RomblonLocation()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function RomblonSeedling()
{
    // Setting header to json
    header('Content-Type: application/json');
