...
class OrientalDashboardController extends BaseController
{
    ...
    public function OrientalDamage()
{
...
public function OrientalFarmers()
{
    // Setting header to JSON
    header('Content-Type: application/json');
...
public function OrientalStanding()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function OrientalTransplate()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function OrientalLocation()
{
    // Setting header to json
    header('Content-Type: application/json');
...
public function OrientalSeedling()
{
    // Setting header to json
    header('Content-Type: application/json');
